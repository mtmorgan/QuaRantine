...
```{r echo = FALSE}
knitr::include_graphics('images/simple_calc.png')
```
...
- To display help from the R Console:
...
```
  ...
  - Use `as.` to coerce a varaible to a specific data type
...
- Vecotrs are a list of elements of the <b><i>same type</b></i>
