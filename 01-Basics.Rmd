...
- Visit [rstudio.cloud][]. Click the 'Get Started' button, and create an account (I used by gmail account...). You should end up at a screen like the following.
...
<img src="images/RStudio-cloud-project.png">
