...
The diagram below illustrates a more concrete "black box" model that converts height, weight, and age into a prediction of whether or not the individual is male or female.
...
- <b>Training Data</b>: this is a data set containing paired observations of inputs (i.e features) and outputs (i.e. labels). Training data is also known as measurement data, observation data or calibration data.
...
- <b>Classification Accuracy</b>: Classification accuracy is the ratio of correct predictions to the total predictions when validating a trained classification algorithm.
